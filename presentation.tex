...
\begin{frame}{Feature Importance — What the Tree Learned}
  ...
  \medskip
  \begin{center}
    \includegraphics[width=0.72\textwidth]{fi_dt.pdf}
  \end{center}
\end{frame}
...
\begin{frame}{Confusion Matrices — Test Set (Apr 14, both symbols)}
  \begin{center}
    \includegraphics[width=0.92\textwidth]{cm_baselines.pdf}
  \end{center}
  \vspace{-0.5em}
  \begin{center}
    {\small \textbf{Key advantage:} DT reduces FN from 26{,}069 to 23{,}530
    — fewest missed sell aggressors of all models.}
  \end{center}
\end{frame}
...
\begin{frame}{Gradient Boosting Model — Benek Kurtyka}
  ...
  \medskip
  \begin{center}
    \includegraphics[width=0.68\textwidth]{fi_gbm.pdf}
  \end{center}
\end{frame}
...
\begin{frame}{All Models — Confusion Matrices}
  \begin{center}
    \includegraphics[width=\textwidth]{cm_all.pdf}
  \end{center}
\end{frame}
